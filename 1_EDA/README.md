...
A SQL project analyzing the business Analyst job market using real world job posting data. It demonstrates my ability to **write production-quality analytical SQL, design efficient queries, and turn business questions into data-driven insights**.

---

## 🧾 Executive Summary (For Hiring Managers)

- ✅ **Project scope:** Built **3 analytical queries** that answer key questions about the business analyst job market  
...
- 🎯 **Most in-demand:** *Which skills are most in-demand for business analyst?*  
...
By querying across these interconnected tables, I extracted insights about skill demand, salary patterns, and optimal skill combinations for business analyst roles.  
...
1. **[Top Demanded Skills](./01_top_demanded_skills.sql)** – Identifies the 10 most in-demand skills for remote businesss analyst positions
...
- 🧠 Core languages: SQL, excel, tableau and python each appear in major job postings, making them the most demanded skills
- 🧱 Infra & tooling: snowflake, go and sas are associated with premium salaries
- 🔥 Big data tools: Power BI shows strong demand with competitive compensation
